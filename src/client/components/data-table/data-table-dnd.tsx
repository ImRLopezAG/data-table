'use client'
import { useColumnOrderManagement, useDataTable } from '@/client/hooks/use-data-table'
...
export function createDataTableDnd<TData = unknown>() {
	...
	const DataTableComponent = ({
		...
		const { table, virtualizer, parentRef, state, handlers } =
			useDataTable({
...
function LazyDraggableTableWrapper<TData>(props: DraggableTableProps<TData>)  {
	const draggableProps = {
		...
		classNames: props.classNames as DraggableTableProps<unknown>['classNames'], 
	}
